          ...
          if (prev_size > 0) {
           ...
           // Prediction
            ...
            for ( int i = 0; i < sensor_fusion.size(); i++ ) {
                ...
                if (d < (2+4*lane+2) && d > (2+4*lane-2)){ //current lane

                  if (check_car_s > car_s && check_car_s - car_s < 18){ 
                    too_close = true;
                  }
                } else if ((4*lane-4) < d && d < (4*lane)) { //left lane
                  if (car_s - 3 < check_car_s && car_s + 18 > check_car_s){
                    left_car = true; //there is a car in this left lane
                  }
                } else if ((4*lane + 4) < d && d < (4*lane+4+4)){ //right lane 
                  if (car_s - 3 < check_car_s && car_s + 18 > check_car_s){
                    right_car = true; //there is a car in this right lane
                  }
                }
            }
