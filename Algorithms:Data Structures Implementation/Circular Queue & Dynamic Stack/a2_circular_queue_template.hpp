...
#ifndef A2_CIRCULAR_QUEUE_TEMPLATE_HPP
#define A2_CIRCULAR_QUEUE_TEMPLATE_HPP

 //replace QueItem with  T

//static const T<int> EMPTY_QUEUE;
template <class T>
class CircularQueue {
public:
